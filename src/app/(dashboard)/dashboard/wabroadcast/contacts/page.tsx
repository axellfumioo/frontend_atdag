    ...
    <div className={`${containerWidthClass} mx-auto px-4 py-4 space-y-4`}>
      <section className="rounded-2xl border border-yellow-100 bg-white/95 px-5 py-5 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-semibold text-gray-900">Kontak WA</h1>
            <p className="mt-1 text-xs sm:text-sm text-gray-600">Kelola kontak WhatsApp untuk siaran dan kampanye.</p>
          </div>
        </div>
      </section>

      <div className="bg-white rounded-2xl shadow-sm border border-yellow-100 overflow-hidden">
        <div className="p-6 text-sm text-gray-500">Belum ada kontak. Ini halaman placeholder.</div>
      </div>
    </div>
  );
}
